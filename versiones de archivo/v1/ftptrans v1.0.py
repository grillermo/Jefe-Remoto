...
# Licence:     GPL v2.0
# version:     1.0
# Notes:       In this version i used functional programming and only standard
...
for ip in range(startingIP,endingIP+1):
    ...
    if os.system("C:\\Windows\\System32\\ping "+currentIP+" -n 1"):
